...
class RawImageDataset(data.Dataset):
    ...
    def __init__(self, data_path, data_name, data_split, tokenzier, opt, train):
        ...
        loc_info = osp.join(data_path, "final_result_w_split_20028_step_question_new.json")
        ...
        for value in tqdm(self.data):
            ...
            elif value["dependency_type"] == "parallel":
    ...
    def __getitem__(self, index):
        ...
        images = [images[_] for _ in used_index]
        targets = [targets[_] for _ in used_index]
        all_caption_attentions = [all_caption_attentions[_] for _ in used_index]
        all_image_att_maps = [all_image_att_maps[_] for _ in used_index]
        goals = [goals[_] for _ in used_index]
        image_index = [image_index[_] for _ in used_index]
        image_ids = [image_ids[_] for _ in used_index]
