...
def build_dict(params):
    ...
    count = 0
    refs_words = []
    for story_id in tqdm(story_line[params['split']].keys()):
        ref_words = []
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='wikiHow/story_line.json',
                        help='the input json file from the dataset')
    parser.add_argument('--output_pkl', default='wikiHow/wikiHow-train', help='output pickle file')
